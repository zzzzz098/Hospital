...
const features = [
  { icon: '🔍', title: '科室医生查询', desc: '按科室或姓名快速查找医生，查看医生详情与排班信息' },
  { icon: '📅', title: '在线预约挂号', desc: '选择合适时段在线预约，方便快捷免排队' },
  { icon: '📋', title: '预约记录管理', desc: '随时查看预约记录，支持取消或修改预约' },
  { icon: '💬', title: '在线问诊留言', desc: '向医生在线留言咨询，获取专业医疗建议' },
  { icon: '📊', title: '后台数据管理', desc: '医生可管理患者档案、排班及预约数据统计' },
  { icon: '💊', title: '药品咨询推送', desc: '及时获取药品资讯与用药指导' },
]
